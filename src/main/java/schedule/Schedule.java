...
//        List<DataBase.schedule.Schedule.Value> scheduleMonday = getDaySortedList(scheduleList, 1);
//        List<DataBase.schedule.Schedule.Value> scheduleTuesday = getDaySortedList(scheduleList, 2);
//        List<DataBase.schedule.Schedule.Value> scheduleWednesday = getDaySortedList(scheduleList, 3);
//        List<DataBase.schedule.Schedule.Value> scheduleThursday = getDaySortedList(scheduleList, 4);
//        List<DataBase.schedule.Schedule.Value> scheduleFriday = getDaySortedList(scheduleList, 5);
//        List<DataBase.schedule.Schedule.Value> scheduleSaturday = getDaySortedList(scheduleList, 6);
//        List<DataBase.schedule.Schedule.Value> scheduleSunday = getDaySortedList(scheduleList, 7);
//
...
//    private List<DataBase.schedule.Schedule.Value> getDaySortedList(List<DataBase.schedule.Schedule.Value> scheduleList,
//                                                           int dayOfWeek) {
